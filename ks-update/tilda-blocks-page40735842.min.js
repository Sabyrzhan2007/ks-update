...
function t1022__paintIcons(recid){var rec=document.querySelector('#rec'+recid);if(!rec)return;var icon=rec.querySelector('.t1022__icon');if(!icon)return;var iconStyle=window.getComputedStyle(icon);var iconColor=iconStyle.getPropertyValue('fill');var iconURL=icon.getAttribute('data-original');if(!iconURL)return;if(iconURL.indexOf('/lib__tildaicon__')===-1&&iconURL.indexOf('/lib/tildaicon/')===-1&&iconURL.indexOf('https://static.tildacdn.com/tild6164-3166-4434-b265-613330313930/circle.svg')===-1&&iconURL.indexOf('https://static.tildacdn.com/tild3435-3031-4565-b439-323735306565/star.svg')===-1&&iconURL.indexOf('https://static.tildacdn.com/tild3836-3733-4133-b431-346465373061/rhomb.svg')===-1&&iconURL.indexOf('https://static.tildacdn.com/tild3336-3766-4730-a266-626536316465/cross.svg')===-1&&iconURL.indexOf('https://static.tildacdn.com/tild3331-6332-4132-b565-663737653932/rhomb2.svg')===-1&&iconURL.indexOf('https://static.tildacdn.com/tild3834-3661-4635-b166-303739306635/arrow.svg')===-1&&iconURL.indexOf('https://static.tildacdn.com/tild3163-6165-4531-b437-616562623533/flake.svg')===-1&&iconURL.indexOf('https://static.tildacdn.com/tild3435-3465-4165-b231-623435653462/heart.svg')===-1){icon.style.backgroundImage='url('+iconURL+')';return}
